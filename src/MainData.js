...
//                     <div style={{width:"30%"}}> <p style={{color:"white",fontSize:"25px",marginLeft:"25px"}}><b>ข้อมูลพนักงาน</b></p></div>
...
//                         <div className='menu'>กำหนดผู้อนุมัติ</div>
//                         <div className='menu'>ช่องทางการรับเงิน</div>
//                         <div className='menu'>ตั้งค่ากะการทำงาน</div>
...
//                     </menu>
//                     <conten>
//                         <div><p style={{fontSize:"30px",marginLeft:"20px"}}>Dashboard</p></div>
