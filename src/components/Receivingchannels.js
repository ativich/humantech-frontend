            ...
            <div>
                ...
                <body>
                    <menu>
                        ...
                        <div className='menu' style={{backgroundColor:"rgb(244, 150, 50)",color:"white"}} onClick={Receivingchannels}>ช่องทางการรับเงิน</div>
                    ...
                    <conten>
                        <div><p style={{fontSize:"30px",marginLeft:"20px"}}><b>ช่องทางการรับเงิน</b></p></div>
                        ...
                        <div style={{width:"95%",marginLeft:"2.5%"}}>
                            <div className="table-container">
                                <table className="responsive-table" style={{width:"100%"}}>  
                                    ...
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>ช่องทางการรับเงิน</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>ธนาคาร</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>รหัสสาขาธนาคาร</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>เลขที่บัญชี</th>
                                    {/* </tr> */}
                                    <tr>
                                        <td style={{textAlign:"center"}}>1</td>
                                        <td> 644306: สุนทรี สิริพชอนันต์ (ติ๋ว)</td>
                                        <td style={{textAlign:"center",width:"15%"}}>
                                            <select className='input' id="select_state" disabled placeholder="">
                                        ...
                                        <td><input className='input' type='text' value=""></input></td>
                                        <td><input className='input' type='number' value={644306}></input></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{textAlign:"center",width:"20%"}}>
                                            <select className='input' id="select_state" placeholder="">
                                                <option value="">KBANK - ธนาคารกสิกรไทย</option>
                                                <option value="">นางสาว</option>
                                            </select>
                                        </td>
                                        <td><input className='input' type='text' disabled value="สาขากระนวน"></input></td>
                                        <td><input className='input' type='number' value={644306}></input></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input className='input' type='text' value="สาขาเซ็นทรัล"></input></td>
                                        <td><input className='input' type='number' value={644306}></input></td>
                                    </tr>
                                    <tr>
...
export default Receivingchannels