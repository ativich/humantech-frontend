            ...
            <div>
                ...
                <body>
                    <menu>
                        ...
                        <div className='menu' style={{backgroundColor:"rgb(244, 150, 50)",color:"white"}} onClick={Data}>ข้อมูลพื้นฐาน</div> 
                    ...
                    <conten>
                        <div><p style={{fontSize:"30px",marginLeft:"20px"}}><b>ข้อมูลพื้นฐาน</b></p></div>
                        ...
                        <div style={{width:"95%",marginLeft:"2.5%"}}>
                            <div className="table-container">
                                <table className="responsive-table" style={{width:"100%"}}>  
                                    ...
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>คำนำหน้าชื่อ</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>ชื่อพนักงาน</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>รหัสพนักงาน</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>รหัสลายนิ้วมือ</th>
                                    <th style={{color:"white",backgroundColor:"rgb(244, 150, 50)",borderRadius:"20px",textAlign:"center"}}>เพศ</th>
                                    {/* </tr> */}
                                    <tr>
                                      ...
                                      <td> <p style={{ marginLeft:"10px"}}> 644306: สุนทรี สิริพชอนันต์ (ติ๋ว)</p></td>
                                      <td style={{textAlign:"center",width:"15%"}}> <input className='input' type='number' value={644306}></input></td>
                                      <td style={{textAlign:"center",width:"15%"}}> <input className='input' type='number' value={644306}></input></td>
                                      <td style={{textAlign:"center",width:"10%"}}>
                                          <select className='input' id="select_state" disabled placeholder="">
                                    ...
                                    <tr>
                                      ...
                                      <td> <p style={{ marginLeft:"10px"}}> 644306: สุนทรี สิริพชอนันต์ (ติ๋ว)</p></td>
                                      <td style={{textAlign:"center",width:"15%"}}> <input className='input' type='number' disabled value={644306}></input></td>
                                      <td style={{textAlign:"center",width:"15%"}}> <input className='input' type='number' disabled value={644306}></input></td>
                                      <td style={{textAlign:"center",width:"10%"}}>
                                          <select className='input' id="select_state" placeholder="">
                                              <option value="">ชาย</option>
